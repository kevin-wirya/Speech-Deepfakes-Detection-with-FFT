...
\bibitem{b1} Ni, Y., et al. (2024). "A Deepfake Detection Algorithm Based on Fourier Transform of Biological Signal." Tech Science Press. (Accessed on December 16, 2025) \url{https://www.techscience.com/cmc/v79n3/57116}
\bibitem{b2} Mai, K. T., Bray, S., Davies, T., and Griffin, L. D.Warning: Humans cannot reliably detect speech deepfakes.PLOS ONE, 18(8):1–20, 2023. (Accessed on December 19, 2025) \url{https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0285333}
\bibitem{b3} Munir, R. (2025). IF2123 Aljabar Linier dan Geometri - Semester I Tahun 2025/2026: Aljabar Kompleks (Update 2024). (Accessed on December 19, 2025) \url{https://informatika.stei.itb.ac.id/~rinaldi.munir/AljabarGeometri/2025-2026/Algeo-25-Aljabar-Kompleks-2025.pdf}
\bibitem{b4} Christensen, M. G. (2019). Introduction to Audio Processing. Springer Nature Switzerland AG. (Accessed on December 19, 2025) \url{https://doi.org/10.1007/978-3-030-11781-8}
\bibitem{b5} Burrus, C.S. (1989). Algorithms for Discrete Fourier Transform and Convolution. Springer Science+Business Media New York. (Accessed on December 20, 2025). \url{https://link.springer.com/book/10.1007/978-1-4757-3854-4}
\bibitem{b6} Uppada, S. K. (2014). Centroid Based Clustering Algorithms- A Clarion Study. International Journal of Computer Science and Information Technologies, Vol. 5 (6), 7309-7313. (Accessed on December 20, 2025). \url{https://www.ijcsit.com/docs/Volume%205/vol5issue06/ijcsit2014050688.pdf}
\bibitem{b7} S. Nordholm, S., Togneri, R., Toh, A. M. (2005). Spectral Entropy as Speech Features for Speech Recognition. PEECS. (Accessed on December 20, 2025). \url{https://www.academia.edu/download/95656320/Spectral_entropy_as_speech_features_for_speech_rec.pdf}
\bibitem{b7} Xiang, S., et al. (2008). Learning a Mahalanobis Distance Metric for Data Clustering and Classification. Tsinghua National Laboratory for Information Science and Technology (TNList). (Accessed on December 20, 2025). \url{https://doi.org/10.1016/j.jesp.2017.09.011}
